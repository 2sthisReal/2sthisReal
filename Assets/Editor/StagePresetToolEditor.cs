...
namespace Jang
{
    ...
    public class StagePresetToolEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            StagePresetTool editor = (StagePresetTool)target;

            if (GUILayout.Button("Save StagePreset")) // Save StagePreset 버튼 생성
            {
                SavePreset(editor); // 버튼을 누르면 SavePreset 메서드 실행
            }
        }

        // 프리셋 저장
        private void SavePreset(StagePresetTool editor)
        {
            // ScriptableObject 생성
